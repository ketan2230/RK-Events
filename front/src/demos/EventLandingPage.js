  ...
  return (
    <AnimationRevealPage>
      ...
      <MainFeature
        ...
        description={
          <Description>
            RK Event Planner, your one stop solution for making any event memorable or a success.
            <br />
            <br />
            We provide Birthday Party, Wedding Arrangements, Bride & Groom Entries, Catering, Baby Shower, Ring Ceremony, Lights & Sound, Photography & Videography and etc.
            <br />
            <br />
            With a Team having an expertise of over 6+ years, your event being a success is guaranteed.
          </Description>
        }
        buttonRounded={false}
        textOnLeft={false}
        ...
        cards={[
          {
            ...
            title: "Availiblity",
            description: "We are available on Website, WhatshApp, Google, Social media platforms like Instagram, Facebook, Linkedin and etc.",
            url: "https://google.com"
          },
          {
            imageSrc: editIcon,
            title: "Customizable",
            description: "By our efforts, We Execute your Imagination, into Reality",
