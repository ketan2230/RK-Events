...
const QuotesLeft = tw(QuotesLeftIcon)`w-6 h-6 opacity-75 text-primary-800 inline-block mr-1 -mt-3`;
const QuotesRight = tw(QuotesRightIcon)`w-6 h-6 opacity-75 text-primary-800 inline-block ml-1 -mt-3`;
